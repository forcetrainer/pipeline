...
// ── Seed Users ─────────────────────────────────────────────────────
// Deterministic IDs for predictability. Passwords are plaintext for now
// and will be replaced by EntraID/MSAL authentication later.
...
export const seedUseCases: UseCase[] = [
  {
    ...
    description:
      'Enterprise-wide AI code review system that scans every pull request for bugs, security vulnerabilities, and performance issues. Deployed across all 50 engineers, it catches costly defects before they reach production.',
    whatWasBuilt:
      'A GitHub Action integration that automatically runs Claude on every PR, generating structured review comments with severity levels. The bot posts inline comments directly on the diff and flags potential security issues.',
    keyLearnings:
      'AI catches about 40% of the issues human reviewers find, but excels at security vulnerabilities and common bug patterns. The $120/use savings reflects average cost of defects caught early vs. in production. Best used as a first pass before human review.',
    metrics: calculateMetrics({
      timeSavedPerUseMinutes: 45,
      moneySavedPerUse: 120,
      numberOfUsers: 50,
    ...
    effort: 'medium',
    status: 'active',
    tags: ['code-review', 'automation', 'engineering'],
    submittedBy: 'Sarah Chen',
    submitterTeam: 'Engineering',
  ...
  },
  {
    ...
    description:
      'Generate first drafts of marketing copy for email campaigns, social media posts, and landing pages. Marketing team reviews and edits for brand voice and accuracy.',
    whatWasBuilt:
  ...
  },
  {
    ...
    description:
      'Automatically classify incoming support tickets by category, priority, and required expertise. Routes tickets to appropriate team members faster.',
    whatWasBuilt:
    ...
    submitterTeam: 'Customer Success',
  ...
  },
  {
    ...
    description:
      'Summarize meeting recordings and notes into actionable items, key decisions, and follow-ups. Distributed to all attendees automatically.',
    whatWasBuilt:
  ...
  },
  {
    ...
    description:
      'Generate personalized outreach emails based on prospect data, recent company news, and previous interactions. Sales reps review and customize before sending.',
    whatWasBuilt:
  ...
  },
  {
    ...
    description:
      'Use AI to analyze datasets and generate narrative reports with insights, trends, and recommendations. Analysts verify findings before distribution.',
    whatWasBuilt:
  ...
  },
  {
    ...
    description:
      'Auto-generate API documentation from code comments and function signatures. Keeps docs in sync with code changes.',
    whatWasBuilt:
  ...
  {
    id: 'uc-008',
    title: 'Competitive Research Assistant',
    description:
      'AI-powered research assistant that monitors competitor activities, product launches, and market trends. Generates monthly briefing documents for leadership review.',
    whatWasBuilt:
      'A monthly automated workflow that scrapes competitor blogs, press releases, and social media, then uses ChatGPT to synthesize a competitive intelligence brief with key takeaways.',
    keyLearnings:
      'The AI is great at synthesizing large volumes of text into digestible summaries. However, it sometimes misinterprets competitive positioning. Having an analyst review the brief before distribution is essential. Low adoption limits the overall impact.',
    metrics: calculateMetrics({
      timeSavedPerUseMinutes: 30,
      moneySavedPerUse: 5,
      numberOfUsers: 2,
    ...
    submittedBy: 'Rachel Foster',
    submitterTeam: 'Strategy',
    submittedById: 'user-008',
    approvalStatus: 'approved',
...
export const seedPrompts: Prompt[] = [
  {
    ...
    tips: 'Include the programming language and any project-specific style guide rules in the prompt for better results. Works best with functions under 100 lines.',
    category: 'Coding',
    aiTool: 'Claude',
    useCaseId: 'uc-001',
  ...
  },
  {
    ...
    tips: 'Always include 3-4 examples of previously approved emails in the prompt. Specify exact character limits for subject lines to avoid truncation in email clients.',
    category: 'Writing',
    aiTool: 'ChatGPT',
    useCaseId: 'uc-002',
  ...
  },
  {
    ...
    effectivenessRating: 5,
    tips: 'Feed in recent examples of correctly classified tickets for few-shot learning. Update the category list as your product evolves. JSON output makes it easy to integrate with ticketing systems.',
    category: 'Analysis',
    aiTool: 'Claude',
    useCaseId: 'uc-003',
  ...
  },
  {
    ...
    effectivenessRating: 4,
    tips: 'Include the meeting agenda at the top of the notes for better context. If using a transcript, note who the speakers are. Ask for bullet points rather than paragraphs for faster scanning.',
  ...
  },
  {
    ...
    effectivenessRating: 4,
    tips: 'The more specific the prospect info, the better the output. Always include a recent news item or LinkedIn post to reference. Test different CTAs (meeting vs. resource share) for your industry.',
    category: 'Writing',
    aiTool: 'ChatGPT',
    useCaseId: 'uc-005',
    tags: ['sales', 'email', 'personalization'],
  ...
  },
  {
    ...
    tips: 'Provide context about what the business cares about measuring. Include comparison benchmarks if available. Ask for confidence levels on each insight to help analysts prioritize what to verify.',
    category: 'Analysis',
    aiTool: 'Claude',
    useCaseId: 'uc-006',
    tags: ['data', 'analysis', 'reporting'],
  ...
  },
  {
    ...
    effectivenessRating: 3,
    tips: 'Include relevant error logs and stack traces. The more system context you provide, the better the root cause hypothesis. Works best for application-level bugs rather than infrastructure issues.',
    category: 'Coding',
    aiTool: 'Claude',
    tags: ['debugging', 'engineering', 'triage'],
    submittedBy: 'Alex Rivera',
    submittedById: 'user-007',
    approvalStatus: 'approved',
  ...
  },
  {
    ...
    effectivenessRating: 4,
    tips: 'Include competitor examples or existing similar features for context. The more specific your success metrics, the better the requirements. Review the "Out of Scope" section carefully to prevent scope creep.',
    category: 'Writing',
    aiTool: 'Claude',
