...
export const seedUseCases: UseCase[] = [
  {
    ...
    description:
      'Use AI to generate initial code review comments on pull requests, focusing on code style, potential bugs, and performance improvements. Reviewers then validate and refine the AI suggestions.',
    whatWasBuilt:
  ...
  },
  {
    ...
    description:
      'AI-powered research assistant that monitors competitor activities, product launches, and market trends. Generates weekly briefing documents.',
    whatWasBuilt:
